...
class Ui_MainWindow(object):
    ...
    def __init__(self, user = None):
        ...
        self.ui_dialog.changeCurrentDay(self.current_day,self.current_Id)
        ###
    ...
    def ware_ventas(self):
        if self.ui_dialog.isVisible():
            print("Hola Mundo")
            #ret = QMessageBox.information(self, 'Aviso', "Debe cerrar la ventana de almacen")
        else:
            if self.current_day:
                self.ui_dialog_.currentDay_printer(self.current_Id,self.current_user.id)
                self.ui_dialog_.currentTable()
            else:
                self.ui_dialog_.currentDay_printer(0,self.current_user.id)
    ...
    def setupUi(self, MainWindow, user = None):
        ...
        # -----------  verifica que exista el dia  -----------
        if self.current_day != True:
